...
//            cv.put(SmsCounterContract.CounterEntry.COLUMN_SIMCARD_COUNTER, 0 );
//            cv.put(SmsCounterContract.CounterEntry.COLUMN_WIFI_COUNTER, parts.size());
...
////        try {
////            sendSmsAfterWriteContactPermission();
////        } catch (Exception e) {
////            Toast.makeText(getApplicationContext(),
////                    "خطایی رخ داد،لطفا بعدا دوباره امتحان کنید",
...
//    public void InternetWay(View view) {
...
//                handler.execute(url);
//            } else {
//                Toast.makeText(this, "این قابلیت فعلا در دسترس نمی باشد", Toast.LENGTH_SHORT).show();
//            }
//        } else {
//            dialogChooseWay.dismiss();
//            AlertDialog.Builder builder = new AlertDialog.Builder(MainActivity.this);
